    ...
    <div className='p-5 bg-secondary border-r-[1px] h-screen relative'>
      ...
      <div className='mt-5'>
        {assistantList.map((assistant_, index) => (
          <div className={`p-2 flex gap-3 items-center hover:bg-gray-200 hover:dark:bg-slate-700 rounded-xl cursor-pointer mt-2 ${assistant_.id==assistant?.id&&'bg-gray-200'}`} key={index} onClick={()=>setAssistant(assistant_)}>
            <Image
      ...
      <div className='absolute bottom-10 flex gap-3 items-center hover:bg-gray-200 w-[87%] cursor-pointer p-2 rounded-xl'>
